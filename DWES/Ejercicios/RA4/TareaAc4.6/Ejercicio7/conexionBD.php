<?php
   ...
   function getPosiciones()
   {
       ...
       $consulta = $conexion->query("SELECT posicion from jugadores");
   
   
   
   
       $posiciones_jugadores = $consulta->fetchAll(PDO::FETCH_COLUMN);
   
       
   
       visualizarContenidoOpciones($posiciones_jugadores);
   ...
   echo "<tr><th>Nombre</th></tr>";
    foreach ($datos as $d) {
        echo "<tr><td>" . htmlspecialchars($d) . "</td></tr> ";
    }
